                            ...
                            <div class="offcanvas-body app-scroll p-0">
                                <div class="head-container">
                                    ...
                                    <div class="head-box">
                                        ...
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank"> Women's
                                                Watch</a>
                                            <div>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                    ...
                                    <div class="head-box">
                                        <img src="{{ asset('../assets/images/ecommerce/09.jpg') }}" alt="cart"
                                            class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank">Sandals</a>
                                            <div>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                    ...
                                    <div class="head-box ">
                                        <img src="{{ asset('../assets/images/ecommerce/23.jpg') }}" alt="cart"
                                            class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank">
                                                Jackets</a>
                                            <div>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                    ...
                                    <div class="head-box ">
                                        <img src="{{ asset('../assets/images/ecommerce/11.jpg') }}" alt="cart"
                                            class="h-50 object-fit-cover me-3 b-r-10">
                                        <div class="flex-grow-1">
                                            <a class="mb-0 f-w-600 f-s-16" href="#" target="_blank"> Shoes</a>
                                            <div>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                                <i class="ti ti-star-filled text-warning f-s-12"></i>
                                    ...
                                    <div class="hidden-massage py-4 px-3">
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-light-primary btn-xs mt-2" href="#"
                                                target="_blank">Shop
                                                Now</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="notification-message head-box">
                                        ...
                                        <div class="message-content-box flex-grow-1 ps-2">
                                            <a href="#" class="f-s-15 text-secondary mb-0">Hey
                                                <span class="f-w-500 text-secondary">Emery McKenzie</span>, get ready:
                                ...
                                <ul class="">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a class="f-w-500" role="button" href="#" target="_blank"
                                    ...
                                    <li>
                                        <a class="mb-0 text-secondary f-w-500" href="#" target="_blank">
